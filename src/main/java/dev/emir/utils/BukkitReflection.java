...
public class BukkitReflection
{
    ...
    static
    {
        try
        {
            ...
            CRAFT_SERVER_GET_HANDLE_METHOD = CRAFT_SERVER_CLASS.getDeclaredMethod("getHandle", new Class[0]);
            ...
            CRAFT_PLAYER_GET_HANDLE_METHOD = CRAFT_PLAYER_CLASS.getDeclaredMethod("getHandle", new Class[0]);
            ...
            CRAFT_ITEM_STACK_AS_NMS_COPY_METHOD = CRAFT_ITEM_STACK_CLASS.getDeclaredMethod("asNMSCopy", new Class[] { ItemStack.class });
    ...
    public static int getPing(Player player)
    {
        try
        {
            int ping = ENTITY_PLAYER_PING_FIELD.getInt(CRAFT_PLAYER_GET_HANDLE_METHOD.invoke(player, new Object[0]));
    ...
    public static void setMaxPlayers(Server server, int slots)
    {
        try
        {
            PLAYER_LIST_MAX_PLAYERS_FIELD.set(CRAFT_SERVER_GET_HANDLE_METHOD.invoke(server, new Object[0]), Integer.valueOf(slots));
        }
        catch (Exception e)
        {
            e.printStackTrace();
    ...
    public static String getItemStackName(ItemStack itemStack)
    {
        try
        {
            return (String)CRAFT_ITEM_STACK_AS_NMS_COPY_METHOD.invoke(itemStack, new Object[] { itemStack });
        }
        catch (Exception e)
        {
            e.printStackTrace();
